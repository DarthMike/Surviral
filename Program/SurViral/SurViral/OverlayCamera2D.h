...
public:
	...
	OverlayCamera2D(const Vector2& position,float globalscale, int layer, int screenwidth, int screenheight, const std::string& name,const Vector2& maxaabb, const Vector2& minaabb):
