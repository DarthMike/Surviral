...
/*	CHANGES FOR THIS PROJECT (HYDRO): (Marked as MIGUEL MODIFICATION)
    ...
    - ADDED FIXED JOINT (http://www.box2d.org/forum/viewtopic.php?f=3&t=3340)(COMMENTS WITH   // FixedJoint start     //FixedJoint end  )
	    Files: b2Joint.h b2Joint.cpp b2World.cpp b2Body.h
		      New -> (b2FixedJoint.h b2FixedJoint.cpp) 
*/
